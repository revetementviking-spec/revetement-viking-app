      ...
      <main className="max-w-7xl mx-auto p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <section className="bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-300 rounded-lg p-4 md:p-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-2 mt-3">
            <a href="/heures" className="text-center bg-white/70 hover:bg-white border border-slate-200 rounded p-2 text-xs font-semibold text-slate-700">⏱️ Horaire</a>
            ...
            <a href="/depenses" className="text-center bg-white/70 hover:bg-white border border-slate-200 rounded p-2 text-xs font-semibold text-slate-700">💸 Dépenses</a>
